            ...
            <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md:mr-10 ">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base ">
                        Explore the crypto World. Buy and sell cryptocurrency easily on Moonbooiz.
                    </p>
                    <button
                        type="button"
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className={commonStyles}>Utility</div>
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10 ">
                    <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorpism">
                        <div className=" flex justify-between flex-col w-full h-full">
                            <div className="flex justify-between items-start ">
                                ...
                                <BsInfoCircle  fondsize={17} color="#fff"/>
                            </div>
                            <div>
                    ...
                    <Input placeholder="Amount (BTC)" name="amount" type="number" handleChange={() => {}}/>
